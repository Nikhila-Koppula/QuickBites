...
import uk.ac.tees.W9618430.tictoccloneapp.adapter.ProfileVideoAdapter
import uk.ac.tees.W9618430.tictoccloneapp.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    fun setUI() {
        profileUserModel.apply {
            ...
            binding.followingCount.text = follwingList.size.toString()
            binding.followerCount.text = follwerlist.size.toString()
